...
PORTAL_CATALOG: list[dict] = [
	...
	{"id": "queue", "route": "/app/healthcare-patient-queue", "page": "healthcare-patient-queue", "icon": "📋", "category": "core", "roles": ["Healthcare Receptionist", "Healthcare Nurse", "Healthcare Physician"], "label_ar": "الانتظار", "label_en": "Queue"},
