...
def execute():
    """Create Healthcare Telemedicine Configuration if it doesn't exist"""
    if not frappe.db.exists("Healthcare Telemedicine Configuration", "Healthcare Telemedicine Configuration"):
        ...
        doc.insert()
        frappe.db.commit()
        print("Healthcare Telemedicine Configuration created successfully")
    else:
        print("Healthcare Telemedicine Configuration already exists")
