...
WORKSPACE_SECTIONS: list[tuple[str, list[WorkspaceLink]]] = [
	(
		...
		[
			...
			("Page", "healthcare-bed-map", "Visual Bed Map"),
			...
			("Page", "healthcare-patient-journey", "Patient Journey Wizard"),
			("Page", "healthcare-follow-up-plans", "Specialty Follow-up Plans"),
			("Page", "healthcare-dental-chart", "Interactive Dental Chart"),
			("Page", "healthcare-specialty-wizard", "Specialty Wizard"),
			("Page", "healthcare-patient-portal", "Patient Portal"),
			("Page", "healthcare-patient-consumer", "Patient Consumer App"),
			("Page", "healthcare-telehealth-room", "Telehealth Video Room"),
	...
	(
		...
		[
			...
			("DocType", "Healthcare Home Visit Request", "Home Visits"),
			("DocType", "Healthcare Remote Monitoring Reading", "RPM Readings"),
			("DocType", "Healthcare Patient Dependent", "Patient Dependents"),
			("DocType", "Healthcare Medical Tourism Case", "Medical Tourism"),
			("DocType", "Healthcare Disaster Recovery Plan", "DR Runbooks"),
			("DocType", "Healthcare Penetration Test Report", "Penetration Tests"),
			("DocType", "Healthcare Pacs Endpoint", "PACS Endpoints"),
			("DocType", "Healthcare Sso Provider", "SSO Providers"),
			("DocType", "Healthcare Load Test Report", "Load Test Reports"),
			("DocType", "Healthcare Radiology Cad Finding", "Radiology CAD"),
			("DocType", "Healthcare Certification Record", "Certifications"),
			("DocType", "Healthcare Pharmacy Delivery Request", "Pharmacy Delivery"),
			("DocType", "Healthcare Claim Denial Appeal", "Claim Appeals"),
			("DocType", "Healthcare Teleradiology Case", "Teleradiology"),
			...
			("DocType", "Healthcare Follow Up Plan", "Specialty Follow-up Plan"),
